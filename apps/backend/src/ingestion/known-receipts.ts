/**
 * Deterministic "OCR" for the receipt images in the pack.
 *
 * ASSUMPTION (see project note): real OCR of arbitrary photographed bills is
 * out of scope for this take-home and too unreliable to grade a settlement on.
