      ...
      <form onSubmit={submit}>
        <Card>
          <CardBody className="u-col u-gap-4">
            ...
            <Field label="Purpose of travel" error={fieldErr.purpose}>
              {(id) => (
                <Input
                  id={id}
                  value={form.purpose}
            ...
            <div className="grid-2">
              <Field label="From city" error={fieldErr.originCity}>
                {(id) => (
                  <Input
                    id={id}
              ...
              <Field label="Destination city" error={fieldErr.destCity}>
                {(id) => (
                  <Input
                    id={id}
                    value={form.destCity}
            ...
            <div className="grid-3">
              ...
              <Field label="From date" error={fieldErr.startDate}>
                {(id) => (
                  <Input id={id} type="date" value={form.startDate} onChange={set('startDate')} />
                )}
              </Field>
              <Field label="To date" error={fieldErr.endDate}>
                {(id) => (
